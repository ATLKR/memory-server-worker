// Legacy SQLite fixture for the retired Seoul-projection transport modules.
// Those modules emit D1/SQLite SQL and are replaced in P-6; until then their
// tests keep exercising the old schema through this adapter. Services and new
// fixtures must use db.mjs (PGlite/PostgreSQL) instead.
