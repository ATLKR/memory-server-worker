/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.staging.jsonc --strict-vars=false` (hash: b1ee912320c6235286e7ad224b9c10fd)
// Runtime types generated with workerd@1.20260907.1 2026-09-08 nodejs_compat
interface __BaseEnv_Env {
	MEMORY_PAYLOADS: R2Bucket;
	DB: D1Database;
	HOT_01: D1Database;
	HOT_02: D1Database;
	...
	RELEASE_MODE: string;
	GA_PROFILE: string;
	PAID_BILLING_ENABLED: string;
	MEMORY_ROUTING_ENABLED: string;
	MEMORY_GENERAL_ROUTING_ENABLED: string;
	MEMORY_SQL_IMPORT_PUBLIC_KEY: string;
	ENROLLMENT_MODE: string;
	AI_MONTHLY_BUDGET_MICROUSD: string;
	AUTO_ERASURE_ENABLED: string;
	BACKGROUND_JOBS_ENABLED: string;
	STORAGE_MODE: string;
	...
	MEMORY_CONSENT_LEDGER: DurableObjectNamespace<import("./src/worker").OrganizationConsentLedger>;
	MEMORY_AGENT_MEMORY_SPACES: DurableObjectNamespace<import("./src/worker").AgentMemorySpaceLedger>;
	MEMORY_AGENT_MEMORY_BUDGET: DurableObjectNamespace<import("./src/worker").AgentMemoryBudgetLedger>;
	MEMORY_SQL: DurableObjectNamespace<import("./src/worker").MemorySqlDatabase>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "OrganizationConsentLedger" | "AgentMemorySpaceLedger" | "AgentMemoryBudgetLedger" | "MemorySqlDatabase";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_ENVIRONMENT" | "RELEASE_MODE" | "GA_PROFILE" | "PAID_BILLING_ENABLED" | "MEMORY_ROUTING_ENABLED" | "MEMORY_GENERAL_ROUTING_ENABLED" | "MEMORY_SQL_IMPORT_PUBLIC_KEY" | "ENROLLMENT_MODE" | "AI_MONTHLY_BUDGET_MICROUSD" | "AUTO_ERASURE_ENABLED" | "BACKGROUND_JOBS_ENABLED" | "STORAGE_MODE" | "STORAGE_SHARDS_JSON" | "MAIL_FROM" | "PUBLIC_ORIGIN" | "SSO_CLIENT_ID" | "PRODUCT_NAME" | "PRODUCT_SHORT_NAME" | "PRODUCT_DESCRIPTION" | "PRODUCT_SUPPORT_EMAIL" | "PRODUCT_ACCENT_COLOR">> {}
}
