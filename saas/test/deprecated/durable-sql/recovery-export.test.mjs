...
import { snapshotCanonical,validateSnapshotPlan } from '../../../src/deprecated-durable-sql/snapshot.ts';
import { SqlDatabaseEngine } from '../../../src/deprecated-durable-sql/engine.ts';
import { SnapshotImporter } from '../../../src/deprecated-durable-sql/snapshot.ts';
import { SqlRecoveryController } from '../../../src/deprecated-durable-sql/recovery.ts';
const module=await import('../../../src/deprecated-durable-sql/recovery-export.ts').catch(error=>{if(error.code==='ERR_MODULE_NOT_FOUND')return {};throw error;});
